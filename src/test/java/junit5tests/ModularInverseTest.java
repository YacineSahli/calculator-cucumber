...
public class ModularInverseTest {
    ...
    public void testConstructor1() {
        // It should not be possible to create a ModularInverse expression without null parameter list
    ...
    public void testConstructor2() {
        // A Times expression should not be the same as a ModularInverse expression
        try {
    ...
    public void testNullParamList() {
        params = null;
        assertThrows(IllegalConstruction.class, () -> op = new ModularInverse(params));
    }
